	...
	return (
		<>
			...
			<div className="home">
				...
				<div id="instructions">
					<div>
						<h1 className="">SPOTIFY TO YOUTUBE</h1>
						<h3>
					...
					<div className="step_title_container">
						<h2 className="step_title_text">
							Step One: Authenticate with Spotify
						</h2>
						<div className="step_desc_container">
							<h3>
								Click Authenticate to log in to your Spotify
								account
							</h3>
							<h3>
								Grant permissions to access your playlist data
							</h3>
						</div>
					</div>
					<div className="step_title_container">
						<h2 className="step_title_text">
							Step Two: Get playlists
						</h2>
						<div className="step_desc_container">
							<h3>
								Click on Get User Playlists to retrieve a list
								of your playlists
							</h3>
						</div>
					</div>
					<div className="step_title_container">
						<h2 className="step_title_text">
							Step Three: Select a playlist for transfer
						</h2>
						<div className="step_desc_container">
							<h3>
					...
					<div className="step_title_container">
						<h2 className="step_title_text">
							Step Four: Search playlist songs on YouTube
						</h2>
						<div className="step_desc_container">
							<h3>
								Once you have selected a playlist, click on
							...
							<h3>
								Double check songs that have special characters
								in the title or artist name
							</h3>
						</div>
					</div>
					<div className="step_title_container">
						...
						<div className="step_desc_container">
							<h3>
								Click Download Song data to download your
								playlist songs and YouTube links as a JSON file
							</h3>
						</div>
					</div>
					<div className="step_title_container">
						<h2 className="step_title_text font-jelleeFont font-bold">
							Step Six: Download Script
						</h2>
						<div className="step_desc_container">
							<h3>
								Due to API limitations from Google, this service
								is unable to automatically Search and add more
								than 200 songs a day
							</h3>
							<h3>
								In order to keep this service free, this python
								script will search the songs from the JSON file
								on your Web broswer and add them to a YouTube
								playlist
							</h3>
							<h3>
							...
							<h3>
								It will automatically open tabs to songs on
								YouTube and control your mouse to add them to a
								playlist.
							</h3>
							<h3>
								This means that you cannot use your computer
								while this task is running, otherwise it will
								fail before adding all songs.
							</h3>
							<h3>
								Run this program when you know the computer will
								not be used.
							</h3>
						</div>
					</div>
